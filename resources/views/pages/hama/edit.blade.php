                            ...
                            <form action="{{ route('hama.update', $hama->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input id="nama" type="text" class="form-control @error('nama')
                                                is-invalid
                                            @enderror" name="nama" autofocus value="{{ $hama->nama }}">
                                            @error('nama')
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <textarea name="gejala" id="gejala" data-height="150"
                                                class="form-control @error('gejala')
                                                    is-invalid
                                                @enderror" placeholder="Tuliskan Gejala Yang Dialami">{{ $hama->gejala }}</textarea>
                                            @error('gejala')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <textarea name="solusi" id="solusi" data-height="150"
                                                class="form-control @error('solusi')
                                                    is-invalid
                                                @enderror" placeholder="Tuliskan Cara Pencegahannya">{{ $hama->solusi }}</textarea>
                                            @error('solusi')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <textarea name="penyebab" id="penyebab" data-height="150"
                                                class="form-control @error('penyebab')
                                                    is-invalid
                                                @enderror" placeholder="Tuliskan Penyebabnya">{{ $hama->penyebab }}</textarea>
                                            @error('penyebab')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            @if ($hama->gambar)
                                                <img src="{{ asset('storage/' . $hama->gambar) }}" class="img-thumbnail mb-2" alt="Gambar Hama" style="max-height: 200px">
                                            @endif
                                            <div id="image-preview" class="image-preview">
                                                <label for="image-upload" id="image-label">Choose File</label>
                                                <input type="file" name="gambar" id="image-upload" class="form-control-file" value="{{ $hama->gambar }}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <button class="btn btn-primary">Update Hama</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
