    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="section-title">Edit Varietas</h2>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <!-- Digunakan Untuk Melakukan Penginputan -->
                            <form action="{{ route('varietas.update', $varietas->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="card-body">
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input id="nama" type="text" class="form-control @error('nama')
                                                is-invalid
                                            @enderror" name="nama" autofocus value="{{ $varietas->nama }}">
                                            @error('nama')
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <textarea name="deskripsi" id="deskripsi" data-height="150"
                                                class="form-control @error('deskripsi')
                                                    is-invalid
                                                @enderror" placeholder="Deskripsi Varietas Anggur">{{ $varietas->deskripsi }}</textarea>
                                            @error('deskripsi')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <textarea name="karakteristik" id="karakteristik" data-height="150"
                                                class="form-control @error('karakteristik')
                                                    is-invalid
                                                @enderror" placeholder="Karakteristik Varietas Anggur">{{ $varietas->karakteristik }}</textarea>
                                            @error('karakteristik')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            @if ($varietas->gambar)
                                                <img src="{{ asset('storage/' . $varietas->gambar) }}" class="img-thumbnail mb-2" alt="Gambar Varietas" style="max-height: 200px">
                                            @endif
                                            <div id="image-preview" class="image-preview">
                                                <label for="image-upload" id="image-label">Choose File</label>
                                                <input type="file" name="gambar" id="image-upload" class="form-control-file" value="{{ $varietas->gambar }}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <button class="btn btn-primary">Update Varietas</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
